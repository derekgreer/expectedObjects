...
namespace ExpectedObjects.Specs
{
    public class when_comparing_equal_complex_types_with_writer
    {
        ...
        Establish context = () =>
            {
                ...
                _expected = new
                                ...
                                }.ToExpectedObject().Configure(ctx => ctx.SetWriter(_mockWriter.Object));
        ...
        It should_write_the_full_accumulated_path_for_the_unqual_member =
            () =>
            ShouldExtensionMethods.ShouldNotBeNull((_results.Where(r => r.Member.Contains("Level1.Level2.Level3")).Select(r => r.Member)).SingleOrDefault());
    }
}