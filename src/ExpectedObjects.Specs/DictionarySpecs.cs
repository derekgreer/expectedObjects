...
{
    class DictionarySpecs
    {
        [Subject("Key/Value Pairs")]
        class when_comparing_unequal_dictionaries_of_string_string_with_different_count
        {
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_unequal_dictionaries_of_string_string_with_same_count
        {
            static IDictionary<string, string> _actual;
            static IDictionary<string, string> _expected;
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_equal_dictionaries_of_string_string
        {
            static IDictionary<string, string> _actual;
            static IDictionary<string, string> _expected;
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_dictionaries_with_equal_int_keys_and_equal_but_different_object_values
        {
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_dictionaries_with_equal_key_of_int_and_value_of_same_object
        {
            static IDictionary<int, object> _actual;
            static IDictionary<int, object> _expected;
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_equal_dictionaries_of_key_string_value_reference_type
        {
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_equal_dictionaries_of_string_dictionary_string_object
        {
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_equal_key_value_pairs_of_string_reference_with_no_equals_overload
        {
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_unequal_key_value_pairs_with_equal_string_keys_and_unequal_reference_type_with_no_overload_values
        {
            static KeyValuePair<string, SimpleType> _actual;
            static KeyValuePair<string, SimpleType> _expected;
            static bool _result;
        ...
        [Subject("Key/Value Pairs")]
        class when_comparing_unequal_nested_dictionaries_of_object_object_with_equal_numbers_of_entries
        {
        ...
        [Subject("Key/Value Pairs")]
        class when_asserting_ordinal_equality_for_dictionaries_with_differing_and_non_matching_data_types
        {
            static IDictionary<object, object> _actual;
            static IDictionary<object, object> _expected;
        ...
        [Subject("Key/Value Pairs")]
        class when_asserting_inordinal_equality_for_dictionaries_with_differing_and_non_matching_data_types
        {
            static IDictionary<object, object> _actual;
            static IDictionary<object, object> _expected;
            static Exception _exception;
