...
{
    class EqualsOverrideSpecs
    {
        [Subject("Equals Override Types")]
        class when_comparing_equal_objects_with_equals_overload
        {
        ...
        [Subject("Equals Override Types")]
        class when_comparing_unequal_objects_with_equals_overload
        {
            static EqualsOverrideType _actual;
            static EqualsOverrideType _expected;
